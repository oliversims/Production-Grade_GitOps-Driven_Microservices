...
echo ""
echo "Next: apply Grafana/Prometheus HTTPRoutes from observability/ (if not done yet)"
echo "  kubectl apply -f observability/HTTProute-grafana.yaml"
echo "  kubectl apply -f observability/target-grp-grafana.yaml"
echo "  kubectl apply -f observability/HTTProute-prometheus.yaml"
echo "  kubectl apply -f observability/target-grp-prometheus.yaml"
echo ""
